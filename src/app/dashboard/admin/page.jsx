...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      fetch("https://resell-hub-server-six.vercel.app/users"),
      fetch("https://resell-hub-server-six.vercel.app/products"),
      fetch("https://resell-hub-server-six.vercel.app/orders"),
    ])
