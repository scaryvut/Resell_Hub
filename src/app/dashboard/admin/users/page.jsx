...
export default function ManageUsers() {
  ...
  const fetchUsers = async () => {
    try {
      const res = await fetch("https://resell-hub-server-six.vercel.app/users");
  ...
  const toggleStatus = async (user) => {
    ...
    try {
      await fetch(
        `https://resell-hub-server-six.vercel.app/users/${user._id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type":
  ...
  const deleteUser = async (id) => {
    ...
    try {
      await fetch(
        `https://resell-hub-server-six.vercel.app/users/${id}`,
        {
          method: "DELETE",
        }
      );
